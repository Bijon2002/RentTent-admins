...
@section('title', 'Create Subscription - RentTent Admin')
...
<div class="create-form-section">
    ...
    <form method="POST" action="{{ route('admin.subscriptions.store') }}" class="create-form">
        @csrf
            ...
            <div class="form-group">
                ...
                <select name="vendor_id" id="vendor_id" required>
                    ...
                    @foreach($vendors as $vendor)
                        <option value="{{ $vendor->menu_id }}" {{ old('vendor_id', 1) == $vendor->menu_id ? 'selected' : '' }}>
