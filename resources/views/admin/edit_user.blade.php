...
@section('title', 'Edit User - RentTent Admin')
...
<div class="create-form-section">
    ...
    <form method="POST" action="{{ route('admin.users.update', $user->user_id) }}" class="create-form">
        @csrf
        @method('PUT')
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nic_number" id="nic_number" value="{{ old('nic_number', $user->nic_number) }}" required>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select name="role" id="role" required>
                    ...
                    <option value="finder" {{ old('role', $user->role) == 'finder' ? 'selected' : '' }}>Finder</option>
